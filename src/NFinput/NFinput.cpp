        ...
        double scalelevel)
{
	...
	if (loadOkay)
	{
		...
		if(!pModel->Attribute("id"))  {
			if(!blockSameComplexBinding) s=new System("nameless",false,globalMoleculeLimit,scalelevel);
			else s=new System("nameless",true,globalMoleculeLimit,scalelevel);
			...
			if(!blockSameComplexBinding) s=new System(modelName,false,globalMoleculeLimit,scalelevel);
			else s=new System(modelName,true,globalMoleculeLimit,scalelevel);
